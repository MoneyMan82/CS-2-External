namespace External_Aimbot
{
    ...
    internal static class AllGunsAuto
    {
            ...
            out AllGunsAutoDebug debug)
        {
            ...
            bool attackHeld = IsGameAttackHeld(mem);
            ...
            (string status, string phase) = RunSemiAutoPulse(mem, defIndex);
            debug = new AllGunsAutoDebug
            {
                ActiveWeapon = weaponName,
                Shooting = true,
        ...
        private static bool IsGameAttackHeld(GameMemory mem) =>
            mem.ReadInt(mem.Client, Offsets.dwAttack) == AttackPress;
